...
const CategoriesView = ({ navigation, route }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <Text style={styles.title}>Kategorie {isLoading ? (
                <Text>(Ładowanie..)</Text>
            ) : (
            ...
            <CategoriesList navigation={navigation} route={route} />
            <TouchableOpacity style={styles.addButton} onPress={() => navigation.navigate('AddCategory', {eventId: route.params.eventId})}>
